...
![Superstore_Analysis](Superstore_Analysis.png) 
...
Technology has the highest profit margin at 50.79%. Office Supplies has the highest sales volume. Furniture has the lowest profit margin.

* ### Sub-Category Performance:
Copiers and Phones have the highest profit margins. Bookcases and Tables have the lowest profit margins.

* ### Segment Performance:
Consumer is the highest-performing segment. Home Office is the lowest-performing segment.
